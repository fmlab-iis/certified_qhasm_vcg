...
qands [::
         QEq
         (QBinop QAdd (QVar r0) (pow2 (QVar mulr01) 64%positive))
         (qadds [:: qmul (QVar x0) (QVar y0);
...
Definition fe25519_mul_stage12_ands_spec :=
  {| spre := fe25519_mul_stage12_pre;
     sprog := fe25519_mul_stage12;
     spost := fe25519_mul_stage12_ands_post |}.
...
Proof.
  split; first by done.
  simpl.
  apply: (spec_weakening _ ands_post_cong).
  exact: valid_fe25519_mul_stage12_ands_spec.
Qed.
