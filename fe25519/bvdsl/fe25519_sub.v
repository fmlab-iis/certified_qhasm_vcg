...
Definition fe25519_sub_pre : bexp :=
let            x0 :=   0 in
let            x1 :=   1 in
let            x2 :=   2 in
let            x3 :=   3 in
...
bvands [::
          ...
          (bvposz n25519);
          bvult (bvvar r0) (bvposz (2^54)%Z);
          bvult (bvvar r1) (bvposz (2^54)%Z);
          bvult (bvvar r2) (bvposz (2^54)%Z);
          bvult (bvvar r3) (bvposz (2^54)%Z);
          bvult (bvvar r4) (bvposz (2^54)%Z)
       ].
...
Lemma valid_fe25519_sub : valid_bvspec (fe25519_sub_inputs, fe25519_sub_spec).
Proof.
  time "valid_fe25519_sub" verify_bvspec.
Qed.
